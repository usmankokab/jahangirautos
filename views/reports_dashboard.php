...
$auth->requireLogin();
require_permission_or_lock('reports', 'view');
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0"><i class="bi bi-bar-chart-line-fill me-2"></i>Reports Dashboard</h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="h4 mb-0">₨<?= number_format($stats['monthly_sales_amount'], 0) ?></div>
                        </div>
                        <div class="align-self-center">
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card bg-warning text-white h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <div class="small">Monthly Rents</div>
                            <div class="h4 mb-0">₨<?= number_format($stats['monthly_rent_amount'], 0) ?></div>
                        </div>
                        <div class="align-self-center">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="h4 mb-0"><?= number_format($stats['overdue_installments']) ?></div>
                        </div>
                        <div class="align-self-center">
    ...
    <div class="row">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="sales_summary_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <a href="installment_analysis_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <a href="customer_performance_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <a href="product_performance_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <a href="overdue_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <a href="rent_summary_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                                <i class="bi bi-graph-up text-primary me-2"></i>
                        ...
                        <a href="rental_utilization_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <a href="rent_customer_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                                <i class="bi bi-people text-info me-2"></i>
                        ...
                        <a href="rent_payment_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
                        ...
                        <a href="rental_profitability_report.php" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <div>
...
function exportAllData() {
    if(confirm('This will export all sales and rent data. Continue?')) {
        window.open('export_data.php?type=all', '_blank');
    }
}
...
function generateMonthlyReport() {
    ...
    if(month) {
        window.open('monthly_report.php?month=' + month, '_blank');
    }
}
